...
@section('content')
  <div class="container">
    <h1>Suivi des personnels GTR</h1>
    <a href="{{ route("concasseur.personnel-gtr.create") }}" class="btn btn-success mb-3"><i class="fas fa-plus"></i>
      Ajouter une entrée</a>
    <form action="{{ route('concasseur.personnel-gtr.index') }}" method="get" class="mb-3">
      <div class="row">
        <div class="col">
          <div class="row">
            <div class="col">
      ...
      <table class="table table-hover">
        ...
        @forelse($entries as $entry)
          <tr>
            ...
            <td>{{ $entry->atelier }}</td>
            <td>
              <a href="{{ route("concasseur.personnel-gtr.edit", $entry->id) }}" class="btn btn-info"><i class="fas fa-edit"></i></a>
              ...
              <form method="post" action="{{ route("concasseur.personnel-gtr.destroy", $entry->id) }}" id="delete-entry-{{ $entry->id }}" style="display: none;">
                @csrf
                @method("DELETE")
              </form>
            </td>
