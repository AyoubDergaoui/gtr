...
class ConcasseurPersonnelGTRController extends Controller
{
  /**
  ...
  public function index(Request $request)
  {
    ...
    return view('concasseur.personnel-gtr.index', ['entries' => $entries, 'from' => $from, 'to' => $to, "personnels" => $personnels, "personnel" => $personnel]);
  }
  ...
  {
    $personnels = Personnel::orderBy('nom')->where('contrat', 'GTR')->get();
    return view('concasseur.personnel-gtr.create', ["personnels" => $personnels]);
  }
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('concasseur.personnel-gtr.index');
  }
  ...
  public function edit($id)
  {
    ...
    return view('concasseur.personnel-gtr.edit', ["entry" => $entry]);
  }
